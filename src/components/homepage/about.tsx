...
const IconTally = ({ className }: { className?: string }) => (
     <svg className={cn("h-10 w-10", className)} viewBox="0 123.306 595.279 595.279" xmlns="http://www.w3.org/2000/svg">
        <defs>
            <radialGradient id="a" cx="-183.69" cy="328.972" r=".76" gradientTransform="matrix(545.6736 0 0 528.3113 100439.305 -173525.125)" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#34364e" stopOpacity={.98}/><stop offset="1" stopColor="#0c0824"/></radialGradient>
        </defs>
...
const IconExcel = ({ className }: { className?: string }) => (
    <svg width="800px" height="800px" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("h-10 w-10", className)}>
...
export default function About() {
  return (
    <section className="py-16 sm:py-24 bg-secondary/50 relative overflow-hidden">
      ...
      <AnimatedIcon className="top-[15%] right-[25%] hidden lg:block" style={{ animationDelay: '2s' }}><IconExcel /></AnimatedIcon>
      <AnimatedIcon className="top-[15%] right-[12%]" style={{ animationDelay: '0s' }}><IconWord /></AnimatedIcon>
