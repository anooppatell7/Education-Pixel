    ...
    <>
      <div className="bg-gradient-to-br from-purple-900 via-blue-900 to-black text-white">
        <div className="container py-16 sm:py-24 text-center">
          <h1 className="font-headline text-4xl font-bold sm:text-5xl">Privacy Policy</h1>
           ...
           <Card className="max-w-4xl mx-auto shadow-lg rounded-lg">
                <CardContent className="p-8 md:p-12">
                     <div className="prose prose-lg max-w-none dark:prose-invert prose-headings:font-headline prose-headings:text-primary">
                        ...
                        <p>
                          Education Pixel ("we," "our," or "us") is committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at ashishkumargiri51@gmail.com.
                        </p>
                        ...
                        <p>
                          If you have questions or comments about this notice, you may email us at ashishkumargiri51@gmail.com or by post to:
                        </p>
                        <p>
                          Education Pixel<br/>
                          bhavdaspur kota bhawaniganj kunda pratapgarh up (230143)
                        </p>
                      </div>
                </CardContent>
           </Card>
